    ...
    <Navbar>
      <NavBody className="max-w-6xl">
        ...
        <div className="flex z-50 items-center gap-3">
          ...
          <button onClick={()=> window.location.href="https://cal.com/newralfounder/schedule-synappses-lms-demo?overlayCalendar=true"} className="flex h-10 w-full items-center justify-center rounded-full bg-[#1F6BFF] px-4 py-2.5 text-sm font-semibold text-white  sm:w-auto">
           Request Demo
      ...
      <MobileNav className="w-full">
        <MobileNavHeader>
          <div className="flex items-center gap-2">
            <Image src="/synappses_logo.svg" alt="synappses logo" width={30} height={30} />
          </div>
