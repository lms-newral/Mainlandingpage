...
export default function DemoHeader() {
  return (
    <section className="relative w-full min-h-[450px] pt-32 pb-20 px-4 flex flex-col items-center text-center bg-[linear-gradient(180deg,_#FFFFFF_0%,_#F3F7FF_100%)]">
